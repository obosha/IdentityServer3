...
{
	/// <summary>
	/// Custom modification to existing ID3 InMemoryUserService.  All we changed was that 
	/// an additional claim has been added to the user in the GetProfileDataAsync method. (A NameIdentifier for what is
	/// passed to us from external IdP).
	/// </summary>
	public class CustomInMemoryUserService : UserServiceBase
	{
		...
		public CustomInMemoryUserService(List<InMemoryUser> users)
		{
			_users = users;
		}
